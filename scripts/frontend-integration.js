 ...
 * This file demonstrates how to integrate Vibeloom with a web frontend
 */

// For React/Vue/Angular applications
export class VibeloomClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VibeloomClient(provider, contractAddress);
